...
This package was developed under the guidance of my PhD advisor Sean Qian. It is used to run the analyses presented in the our first preprint `Statistical inference of travelers' route choice preferences with system-level data`[link](https://arxiv.org/abs/2204.10964)
