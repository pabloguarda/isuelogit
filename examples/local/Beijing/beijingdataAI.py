...
raw_df = tt.beijing.read_beijing_data(folder_path=folder_path)

# =============================================================================
# Codebook
# =============================================================================
df_dict = tt.beijing.get_dictionary_beijing_data()
...
r = tt.beijing.request_gis_data(url = "") # Go and read json local file

lines_info ,stations_info = tt.beijing.get_lines_stations_info(r.text)
# print(lines_info,'\n',stations_info)
# 建立邻接表
neighbor_info = tt.beijing.get_neighbor_info(lines_info)
print(neighbor_info)
...
tt.beijing.get_distance(stations_info, ostation,dstation)
final_route = tt.beijing.get_path_BFS(neighbor_info,lines_info,ostation,dstation)
...
paths = tt.beijing.get_path_Astar(lines_info, neighbor_info, stations_info, '回龙观', '西二旗')
if paths:
...
df['aerial_distance'] = [tt.beijing.get_distance_metres(*row) for row in df[['ostation_lat','ostation_lon','dstation_lat','dstation_lon']].values]
