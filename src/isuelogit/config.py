...
def set_main_dir(dir = None):
    ...
    dirs = {'folder_pablo_networks': main_dir + "/input/public/networks/pablo/",
            'folder_tntp_networks': main_dir + "/input/public/networks/github/",
